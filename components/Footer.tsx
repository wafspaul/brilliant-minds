      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="col-span-1 md:col-span-1 lg:col-span-1">
            ...
            {/* TODO: Replace href values with actual social media handles when available */}
            <div className="flex space-x-4">
              <a
                href="https://twitter.com/brilliantminds"
                target="_blank"
          ...
          <div className="col-span-1">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <a href="tel:+254756556522" className="text-gray-400 hover:text-blue-400 transition-colors duration-200">
                  +254 756 556 522
                </a>
              </div>
              <div className="flex items-start">
                <Mail size={20} className="text-blue-400 mr-3 mt-1 flex-shrink-0" />
                <a href="mailto:hello@brilliantminds.co.ke" className="text-gray-400 hover:text-blue-400 transition-colors duration-200">
                  hello@brilliantminds.co.ke
                </a>
              </div>
              <div className="flex items-start">
