...
const AboutPage = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      bio: "We are looking for a hands-on engineer who wants to build real tools that matter. If that is you, reach out.",
      image: "/images/team-cto.jpg",
      expertise: ["Full-Stack Engineering", "System Architecture", "API Design"],
      achievements: "Join us and write this section",
      location: "Nairobi, Kenya",
    },
    {
      name: "Open Position",
      role: "Community Lead",
      bio: "We need someone embedded in Kenyan communities who can bridge the gap between what we build and who actually uses it.",
      image: "/images/team-community.jpg",
      expertise: ["Community Engagement", "Partnerships", "Field Research"],
      achievements: "Join us and write this section",
      location: "Nairobi, Kenya",
    },
    {
      ...
      bio: "We are designing a skills platform from the ground up. We want someone who knows how people actually learn, not just how courses are built.",
      image: "/images/team-education.jpg",
      expertise: ["Curriculum Design", "Learning Analytics", "EdTech"],
      achievements: "Join us and write this section",
      location: "Nairobi, Kenya",
    },
  ]
  ...
  const impactMetrics = [
    { number: "6,000+", label: "People Reached", icon: Users },
    { number: "47", label: "Counties Mapped", icon: MapPin },
    { number: "2", label: "Live Platforms", icon: Globe },
    { number: "Nairobi", label: "Home Base", icon: TrendingUp },
  ]
