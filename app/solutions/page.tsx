  ...
  const solutions = [
    {
      ...
      liveName: "Kenya Connectivity Map",
      features: [
        {
          icon: Smartphone,
      ...
      stats: { number: "47", label: "Counties Mapped" },
    },
    {
      id: "e-learning",
      icon: BookOpen,
      ...
      stats: { number: "Coming", label: "In Development" },
    },
    {
      id: "gig-economy",
      icon: Briefcase,
      ...
      stats: { number: "Live", label: "AI Job Matching" },
    },
    {
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {solutions.map((solution, index) => (
              <div
                key={index}
                className={`section-reveal card-hover ${solution.bgColor} p-8 text-center border border-gray-100 shadow-lg flex flex-col`}
              >
                <div
                ...
                {solution.liveUrl ? (
                  <a
                    ...
                    className={`mt-auto inline-flex items-center justify-center gap-2 px-4 py-2 rounded-full text-sm font-semibold text-white bg-gradient-to-r ${solution.color} hover:opacity-90 transition-opacity`}
                  >
                    <span>Live: {solution.liveName}</span>
                    <ArrowRight className="w-4 h-4" />
                  </a>
                ) : (
                  <span className="mt-auto inline-block px-4 py-2 rounded-full text-sm font-medium text-gray-500 bg-gray-100">
                    In Development
                  </span>
                )}
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              {solutions[currentSolutionIndex].liveUrl && (
                <a
                  href={solutions[currentSolutionIndex].liveUrl!}
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`inline-flex items-center gap-2 px-6 py-3 rounded-full text-white font-semibold bg-gradient-to-r ${solutions[currentSolutionIndex].color} hover:opacity-90 transition-opacity`}
                >
                  Open {solutions[currentSolutionIndex].liveName}
                  <ArrowRight className="w-4 h-4" />
                </a>
              )}
            </div>
